...
public class Install {
	...
	public static void main(String[] args) {
        ...
        if (!isLinked) {
    		...
    		System.out.println("Copyright (C) 1999-2015, Wolfram Research, Inc. All Rights Reserved.");
        ...
        for (int i = 0; i < args.length - 1; i++) {
            if (args[i].equalsIgnoreCase("-init")) {
                ...
                try {
                    ...
                    if (inStr != null)
                        try { inStr.close(); } catch (IOException ee) {}
                }
            }
        }
        ...
        try {
            ...
            if (securityProperties != null) {
                securityManager = new JLinkConfigurableSecurityManager(securityProperties);
